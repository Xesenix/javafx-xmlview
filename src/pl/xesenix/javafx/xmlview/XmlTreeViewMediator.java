package pl.xesenix.javafx.xmlview;
...
public class XmlTreeViewMediator
{
	...
	private WeakHashMap<Object, TreeItem<Object>> elementToItemMap = new WeakHashMap<Object, TreeItem<Object>>();
	 ...
	 * @param xmlElement
	 */
	protected TreeItem<Object> convertElementToTreeItem(Object xmlElement)
	{
		TreeItem<Object> treeViewElementItem = new TreeItem<Object>(xmlElement);
		...
		if (xmlElement instanceof Element)
		{
			...
			{
				TreeItem<Object> treeViewAttributeItem = new TreeItem<Object>(attribute);
			...
			for (Object obj : ((Element) xmlElement).getContent())
			{
				if (obj instanceof Text)
				{
					...
					{
						TreeItem<Object> treeViewTextItem = new TreeItem<Object>(obj);
